...
export class ListUpdateFormComponent implements OnInit {
  ...
  onGetFolders() {
    let files:string[] = ["a","b"] ;
    this.listService.getFolderContent(`/Users/shantanu/Documents/GitHub/js-frameworks/Angular_lte_4/shan-cms-template/src/assets/all-images/`)// { fileName: "tedt",description:"hefhkf"})
    .subscribe(
      (response:any)=> { 
        files = response ;
      },
