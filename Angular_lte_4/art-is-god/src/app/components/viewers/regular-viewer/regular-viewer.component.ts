import { ImageElement } from  '../../../../assets/data-and-config/data/image.list';
...
export class RegularViewerComponent implements OnInit {
  ...
  thumbnailStyle(source:any) {
    return  this.listFunnelService.daysAgoUploaded(source) <= 7 ? { 'border': '2px solid orange'} : { 'border': 'none'}
  }
