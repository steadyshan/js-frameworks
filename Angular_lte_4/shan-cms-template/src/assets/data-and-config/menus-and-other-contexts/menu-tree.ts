...
export const MenuTree: MenuItem[] = [
    ...
    { tab:"Gurus and Mystics", label:  'Spiritual Souls:Datta Lineage, Sikhs, East of India', child: false, parent:true, uniqueKey: '', parentKey: 'art', dateUploaded: '02-13-2023', key: 'dattavatar', roles: ['relgion', 'all'] },
    ...
    { tab:"Gurus and Mystics", label:  'Shree Swami Samartha (Q2 2023 onward)', child: false, uniqueKey: '', parentKey: 'Swami Samarhta', key: 'swami-samartha-q2-2023', roles: ['relgion', 'all'], dateUploaded: '04-24-2023' },
...
export class MenuNav {
    _menuTree: MenuItem[] = [
        ...
        { tab:'', label:'The Best', child: false, uniqueKey: '', parentKey: 'art', key: 'showpiece', roles: ['all'] },
        { tab:'', label:'Latest Uploads', child: false, uniqueKey: '', parentKey: 'art', key: 'latest-uploads', roles: ['relgion', 'all'] },
        { tab:'', label:'Shree Ganesh ', child: false, uniqueKey: '', parentKey: 'art', key: 'shree-ganesh', roles: ['relgion', 'all'], dateUploaded: '12-11-2021' },
        { tab:'', label:'Shree Ganesh Q4 2021 onward', child: false, uniqueKey: '', parentKey: 'art', key: 'shree-ganesh-gte-q4-2021', roles: ['relgion', 'all'], dateUploaded: '12-14-2021' },
        { tab:'', label:'Goddesses', child: false, uniqueKey: '', parentKey: 'art', key: 'devi', roles: ['relgion', 'all'] },
        { tab:'', label:'Mahadev', child: false, uniqueKey: '', parentKey: 'art', key: 'mahadev', roles: ['relgion', 'all'], dateUploaded: '12-13-2021' },
        { tab:'', label:'Mahadev and Family', child: false, uniqueKey: '', parentKey: 'art', key: 'mahadev-family', roles: ['relgion', 'all'], dateUploaded: '12-11-2021' },
        { tab:'', label:'Laxmi, Narayan, Shree Ram, and family, Bajrangbali', child: false, uniqueKey: '', parentKey: 'art', key: 'laxmi-vishnu-hanuman', dateUploaded: '01-19-2022', roles: ['relgion', 'all'] },
        { tab:'', label:'Satgurus of Lord Datta Lineage', child: false, uniqueKey: '', parentKey: 'art', key: 'dattavatar', roles: ['relgion', 'all'] },
        { tab:'', label:'Shree Swami Samartha', child: false, uniqueKey: '', parentKey: 'art', key: 'swami-samartha', roles: ['relgion', 'all'], dateUploaded: '12-09-2021' },
        { tab:'', label:'Shirdi Sai Q1 Q2(+Q3)2021', child: false, uniqueKey: '', parentKey: 'art', key: 'shirdi-sai-q1-q2-2021', roles: ['relgion', 'all'] },
        { tab:'', label:'Shirdi Sai Q3 Q4 2021', child: false, uniqueKey: '', parentKey: 'art', key: 'shirdi-sai-q3-q4-2021', roles: ['relgion', 'all'], dateUploaded: '12-12-2021' },
        { tab:'', label:'Shirdi Sai Satcharitra', child: false, uniqueKey: '', parentKey: 'art', key: 'baba-themes-1', roles: ['relgion', 'all'], dateUploaded: '12-06-2021' },
        { tab:'', label:'People', child: false, uniqueKey: '', parentKey: 'art', key: 'people-places', roles: ['nonLiving', 'all'], dateUploaded: '02-24-2022' },
        { tab:'', label:'Places, Scenes and Objects', child: false, uniqueKey: '', parentKey: 'art', key: 'places-scenes-objects', roles: ['nonLiving', 'all'], dateUploaded: '12-06-2021' },
        { tab:'', label:'Misc, Themes', child: false, uniqueKey: '', parentKey: 'art', key: 'themes-misc', roles: ['nonLiving', 'all'] },
        { tab:'', label:'Rail', child: false, uniqueKey: '', parentKey: 'art', key: 'trains', roles: ['nonLiving', 'all'], dateUploaded: '12-08-2021' },
        { tab:'', label:'Aircraft, Ships and Cars', child: false, uniqueKey: '', parentKey: 'art', key: 'planes', roles: ['nonLiving', 'all'], dateUploaded: '07-20-2022' },];
