...
export const MenuTree:MenuItem[] = [
        ...
        { label: 'Shree Ganesh Q4 2021 onward', uniqueKey:'', parentKey:'art', key:'shree-ganesh-gte-q4-2021', roles:['relgion','all'], dateUploaded: '02-08-2022' },
        ...
        { label: 'Shirdi Sai Q2 Q3 2022', uniqueKey:'', parentKey:'art', key:'shirdi-sai-q2-q3-2022', roles:['relgion','all'],dateUploaded: '04-20-2022'},
        ...
        { label: 'Aircraft, Ships and Cars', uniqueKey:'', parentKey:'art', key:'planes', roles:['nonLiving','all'],  dateUploaded: '04-20-2022'}  ];
@Injectable()
