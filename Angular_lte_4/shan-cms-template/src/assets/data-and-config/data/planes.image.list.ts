 ...
 public allImageList:ImageElement[]  =  [
    { 
        ...
        files: [
            ...
            { 
                ...
                { 
                    ...
                    iterations:[
                        ...
                        rating: 1,
                        canvasSize: 'A4', content:'color-pencil', description: `<ul><li>Arjun Main Battle Tank Mk1B or Mk2</li>
                ...
                { 
                    ...
                    rating: 1,
                    canvasSize: 'A3', content:'color-pencil', description: `<ul><li>Celebrating the commission of new INS Vikrant into the Indian Navy Sept 2 2022</li>
                ...
                { 
                    ...
                    canvasSize: 'A3 A4', content:'black-white color-pencil', description: `<ul><li>Attempt on Bismark (or Tirpitz) 07-15-2022</li></ul> `,
                    dateUploaded: '07-23-2022', },
               ,
            {
                    fullFileName: 
                `assets/all-images/ships/QueenElizabethApril10-1620222_final.jpeg`, 
                canvasSize: 'A4', content:'color-pencil', description: `<ul><li>RMS Queen Elizabeth </li>
            ...
            canvasSize: 'A4', content:'black-white', description: `<ul><li>Tempted to draw a US Battleship - the ship in the foreground started off with USS North Carolina in mind, but... </li>
            ...
            dateUploaded: '01-10-2022' }, { 
                ...
                canvasSize: 'A3 A4', content:'black-white color-pencil', description: `<ul>
            ...
            { 
                ...
                canvasSize: 'A4', content:'black-white', description: `<ul><li>The One that started it ALL!!</li>
            ...
            ,
            {
               ...
               dateUploaded: '12-12-2021'
                ...
                canvasSize: 'A3 A4', content:'black-white color-pencil', description: `<ul><li>Spitfire attempt  Sept   2020</li>
            ...
            },
            {
                ...
                canvasSize: 'A3 A4', content:'black-white color-pencil', description: `<ul><li>..Switching to Q2 2021, and attempts to draw contemprary aircraft</li>
            ...
            },
            {
                ...
                canvasSize: 'A3 A4', content:'black-white color-pencil', description: `<ul><li>Another of my favorite themes as a kid, a full sailed sailing ship - sketch before Qe3 2020</li>
                            </ul> `,
            ...
            },
            {
                ...
                canvasSize: 'A3 A4', content:'black-white color-pencil', description: `<ul><li>Around start 2021 - venturing into very rarely visited theme - automobiles * </li>
            ...
            },
            {
                ...
                canvasSize: 'A3 A4', content:'black-white color-pencil', description: `<ul><li>A friend of mine bought one of these way back in 2000 - plymouth prowler</li>
            ...
            },
            {
                    ...
                    canvasSize: 'A3 A4', content:'black-white color-pencil', description: `<ul><li>A most fascinating car - attempt to draw 2011 Acura TL (tech package)</li>
