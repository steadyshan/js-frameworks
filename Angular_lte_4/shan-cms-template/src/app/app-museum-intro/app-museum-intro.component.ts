...
export class AppMuseumIntroComponent implements OnInit {
  ...
  introContentList:string[] = [
      `<H1>A Journey of Sketches </H1>
        <p>
            ...
            Drop in liking for World War 2 storoes and Commando comics, making for themes involving anything to do with modes of transport = 
            from dogfights to train yards, the occasional ship and tank.
  ...
  constructor() {
    this.introContent = this.introContentList[this.context];
   }
